...
const CANDIDATES: { label: string; canon: boolean; odd: string; set: PokemonSet }[] = [
  ...
  { label: 'Mega Pyroar', canon: false, odd: 'Fire Mane (custom, unemulated)', set: mk('Pyroar', 'Unnerve', 'Pyroarite', 'Modest', E({ spa: 252, hp: 4, spe: 252 }), ['Hyper Voice', 'Flamethrower', 'Dark Pulse', 'Protect']) },
  ...
  { label: 'Mega Eelektross', canon: false, odd: 'Eelevate (custom, unemulated)', set: mk('Eelektross', 'Levitate', 'Eelektrossite', 'Modest', E({ spa: 252, hp: 4, spe: 252 }), ['Thunderbolt', 'Flamethrower', 'Giga Drain', 'Protect']) },
